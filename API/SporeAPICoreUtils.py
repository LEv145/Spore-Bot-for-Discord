...
def XMLURL(assetId):
    ...
    sub2 = assetId[3:6]
    sub3 = assetId[6:9]
    return serverString + '/static/model/' + sub1 + '/' + sub2 + '/' \
        + sub3 + '/' + assetId + '.xml'
...
def LargeAssetURL(assetId):
    ...
    sub2 = assetId[3:6]
    sub3 = assetId[6:9]
    return serverString + '/static/image/' + sub1 + '/' + sub2 + '/' \
        + sub3 + '/' + assetId + '_lrg.png'
...
def AssetURL(assetId):
    ...
    sub2 = assetId[3:6]
    sub3 = assetId[6:9]
    return serverString + '/static/thumb/' + sub1 + '/' + sub2 + '/' \
        + sub3 + '/' + assetId + '.png'


def BlockMapURL(blocktype):
    return serverString + '/www_static/data/Blocks/' + blocktype \
        + '.xml'  # todo: change to lowercase


def PaintMapURL(blocktype):
    return serverString + '/www_static/data/Paints/' + blocktype \
        + '.xml'  # todo: change to lowercase
...
def AssetsForUserURL(username, start, length):
    return serverString + '/rest/assets/user/' + username + '/' \
        + str(start) + '/' + str(length)


def BuddiesForUserURL(username, start, length):
    return serverString + '/rest/users/buddies/' + username + '/' \
        + str(start) + '/' + str(length)
...
def AchievementsForUserURL(username, start, length):
    return serverString + '/rest/achievements/' + username + '/' \
        + str(start) + '/' + str(length)
...
def CommentsForAssetURL(assetId, start, length):
    return serverString + '/rest/comments/' + assetId + '/' \
        + str(start) + '/' + str(length)
...
def AssetsForSporeCastURL(sporecastId, start, length):
    return serverString + '/rest/assets/sporecast/' + sporecastId + '/' \
        + str(start) + '/' + str(length)
...
def AssetSearch(
    ...
    return serverString + '/rest/assets/search/' + searchType + '/' \
        + str(start) + '/' + str(length) + '/' + assetType
